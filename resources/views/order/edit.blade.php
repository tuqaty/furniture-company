                ...
                <div class="card-body">
                    <form  action="{{ route('order.update' , $order->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="date" value="{{old('date',$order->date)}}" class="form-control" required/>
                        </div>
                        <div class="form-group">
                            <label class="label">order note: </label>
                            <input type="text" name="note" value="{{$order->note}}" class="form-control"  required/>
                        </div>
                        <div class="form-group">
                            <label class="label">order hall_id: </label>
                            <input type="number" name="hall_id" value="{{$order->hall_id}}" class="form-control"   required/>
                        </div>
                        <div class="form-group">                        
